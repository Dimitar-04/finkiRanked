  ...
  return (
    ...
    >
      ...
      <form
        ...
        className="fieldset bg-base-200 border-base-300 rounded-box w-full max-w-sm border p-6 sm:p-8 space-y-4 sm:space-y-3 2xl:space-y-5"
      >
        <div>
        ...
        <div
          ...
          title={!email || !password ? 'Please fill in all fields' : ''}
        >
          <button
            type="submit"
        ...
        <p className="text-sm mb-3 text-center">or continue with Google</p>
        <button
          type="button"
